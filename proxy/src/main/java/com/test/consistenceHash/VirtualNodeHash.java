...
public class VirtualNodeHash {
    ...
    private static final String VIRTUAL_FLAG = "&&";
    ...
    static{
        ...
        for (String str : realNodes){
            for(int i=0; i<VIRTUAL_NODES; i++){
                String virtualNodeName = str + VIRTUAL_FLAG +"VN" + String.valueOf(i);
    ...
    private static String getServer(String key){
        ...
        if(virtualNode !=null && !"".equals(virtualNode)){
            return virtualNode.substring(0, virtualNode.indexOf(VIRTUAL_FLAG));
        }
        return null;
    }

    public static void main(String[] args){
        String[] keys = {"太阳", "月牙", "星光","大小","高低","吃货"};
